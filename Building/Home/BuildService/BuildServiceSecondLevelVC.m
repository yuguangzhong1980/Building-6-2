...
@interface BuildServiceSecondLevelVC ()<UITableViewDataSource, UITableViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)gainFYServiceSecondLevelVCData{
    ...
    [HomeNetworkService gainBuildServiceSecondLevelVCDataSuccess:^(NSArray *banners) {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    NSInteger row = [indexPath row];
    BuildCropServiceTwoLevelDetailModel *model = self.datasource[row];
    BuildServiceHouseListVC *hoseListVC = [[BuildServiceHouseListVC alloc] init];

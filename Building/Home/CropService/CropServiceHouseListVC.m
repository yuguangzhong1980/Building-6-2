...
@interface CropServiceHouseListVC ()<UITableViewDataSource, UITableViewDelegate, CJDropDownMenuViewDelegate, CJMenuSelectThreeConViewDelegate, CJMenuSelectOneConViewDelegate, UITextFieldDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (strong, nonatomic) CJDropDownMenuView *sectionView;
@property (strong, nonatomic) NSMutableArray <ServiceItemModel*> *houseList;
...
@implementation CropServiceHouseListVC
...
- (void)gainServiceListWithRefresh:(BOOL)isRefresh
{
    ...
    [FangYuanNetworkService gainServiceListWithParams:params headerParams:paramsHeader Success:^(id  _Nonnull response) {
        ...
        [wself.houseList addObjectsFromArray:serviceListModel.data];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ServiceItemModel *model = self.houseList[indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ServiceItemModel *model = self.houseList[row];

...
-(instancetype)initDatePickWithDate:(NSDate *)defaulDate maxDate:(NSDate *)maxDate datePickerMode:(UIDatePickerMode)datePickerMode isHaveNavControler:(BOOL)isHaveNavControler{
    ...
    if (self) {
        ...
        [self setUpDatePickerWithdatePickerMode:datePickerMode maxDate:maxDate];
        [self setFrameWith:isHaveNavControler];
    }
    return self;
}
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode maxDate:(NSDate *)maxDate{
...
-(UIToolbar *)setToolbarStyle{
    ...
    UIBarButtonItem *leftSpace=[[UIBarButtonItem alloc] initWithTitle:nil style:UIBarButtonItemStylePlain target:self action:nil];
    ...
    UIBarButtonItem *rightSpace=[[UIBarButtonItem alloc] initWithTitle:nil style:UIBarButtonItemStylePlain target:self action:nil];
...
//            if (_datePicker.date.hour == 0 && _datePicker.date.minute == 0) {
//                defaultDate = [defaultDate dateByAddingMinutes:5];
//            }
//        }
//        formatter.dateFormat = @"yyyy-MM-dd HH:mm:ss +0000";
        formatter.dateFormat = @"yyyy年MM月dd日 HH:mm:ss +0000";
...
- (void)setMinuteInterval:(NSInteger)interval {
    ...
    if (_datePicker.datePickerMode == UIDatePickerModeCountDownTimer) {
        ...
        _datePicker.minuteInterval = interval;
    }
}

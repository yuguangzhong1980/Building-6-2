...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/KINWebBrowser/Assets/backbutton.png"
  install_resource "${PODS_ROOT}/KINWebBrowser/Assets/backbutton@2x.png"
  install_resource "${PODS_ROOT}/KINWebBrowser/Assets/backbutton@3x.png"
  install_resource "${PODS_ROOT}/KINWebBrowser/Assets/forwardbutton.png"
  install_resource "${PODS_ROOT}/KINWebBrowser/Assets/forwardbutton@2x.png"
  install_resource "${PODS_ROOT}/KINWebBrowser/Assets/forwardbutton@3x.png"
